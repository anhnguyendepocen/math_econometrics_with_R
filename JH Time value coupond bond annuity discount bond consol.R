...
# PRESENT VALUE OF PROTOTYPICAL BONDS
# Annual coupon payments (in currency units, e.g. $): yrcoupon
# The discount rate (in decimal form) is per annum (p.a.): drate
# The maturity is in whole years: ymaturity
# The face value, if any, in currency units (e.g. in $): facev
